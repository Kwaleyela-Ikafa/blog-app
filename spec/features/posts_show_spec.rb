...
RSpec.feature 'Posts', type: :feature do
  before(:each) do
    ...
    @comment1 = Comment.create(post: @last_post, author: @second_user, text: 'This is the 1st comment on the last post')
    @comment2 = Comment.create(post: @last_post, author: @second_user, text: 'This is the 2nd comment on the last post')
    @comment3 = Comment.create(post: @last_post, author: @second_user, text: 'This is the 3rd comment on the last post')
  end
